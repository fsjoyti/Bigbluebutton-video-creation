						   ...
						   fileinput = directory+'/'+ dic['@xlink:href']
							...
							input_array = inputstring.split(' ')
							       ...
							       #print (duration)
                                                               ...
                                                               #print output[1]
                                                               os.chdir(output[0])
                                                               output_value = output[1].replace('png','mpg')
                                                               ...
                                                               string = 'sudo ffmpeg '+'-loop 1'+' '+ '-i'+ ' '+output[1]+' '+ '-c:v libx264 -maxrate 3000k -bufsize 3000k -t' + ' '+str(duration) +' '+'-pix_fmt yuv420p'+' '+'-y'+' '+ output_name                                            
							...
							time_in = float(dic['@in'])
 							...
 							#print (datetime.datetime.fromtimestamp(int(duration)).strftime('%M:%S'))
                                                       ...
                                                       # print minutes
                                                        ...
                                                        os.chdir(output[0])
                                                        output_value = output[1].replace('png','mpg')
                                                        string = 'sudo ffmpeg -loop 1 -i'+' '+output[1] +' '+ '-c:v libx264 -maxrate 3000k -bufsize 3000k '+'-t'+' '+str(duration)+' '+ '-pix_fmt yuv420p'+' '+'-y'+' '+ output_value
